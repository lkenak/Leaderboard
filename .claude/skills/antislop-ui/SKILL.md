...
- **Tell:** literal emoji scattered through the copy, headings, badges, and buttons: a rocket in a headline, a checkmark beside every feature bullet, a flame on a CTA, a chart above a chart title.
...
- **Tell:** an arrow glyph placed on almost every button as pure decoration.
